...
To help with those cases and to aid with the code style we are using [`eslint`](https://eslint.org/) with [`standardjs`](https://standardjs.com/) as a base.  
...
* [**Netifly**](https://www.netlify.com/), used to deploy the project after the master branch is changed.
